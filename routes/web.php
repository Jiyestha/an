...
// -----------------------------login staff----------------------------------------//
Route::controller(LoginStaffController::class)->group(function () {
    Route::get('/loginstaff', 'loginStaff')->name('loginstaff');
    Route::post('/loginstaff', 'authenticateStaff');
    Route::get('/logoutstaff', 'logoutStaff')->name('logoutstaff');
});
